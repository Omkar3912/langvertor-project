...
root=Tk()
root.title("Langvertor - Music Player")
...
translate=Button(root,text="Translator",font=("Roboto",15),activebackground="white",cursor="hand2",bd=1,width=15,height=1,bg="Black",fg="White",command= translator_window)
translate.place(x=300,y=50)

translate=Button(root,text="Text to Speech",font=("Roboto",15),activebackground="white",cursor="hand2",bd=1,width=15,height=1,bg="Black",fg="White",command= audio_window)
translate.place(x=500,y=50)

translate=Button(root,text="Help ChatBot",font=("Roboto",15),activebackground="white",cursor="hand2",bd=1,width=15,height=1,bg="Black",fg="White",command= chat_window)
translate.place(x=700,y=50)
